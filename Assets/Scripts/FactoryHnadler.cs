...
public class FactoryTask : MonoBehaviour, ITaskHandler
{
    ...
    {
        var inputStacker = agent.GetStacker(ItemType.Ore);
        var outputStacker = agent.GetStacker(ItemType.HandCuffs);
        while (true)
        {
